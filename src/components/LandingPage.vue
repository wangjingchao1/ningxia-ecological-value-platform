  ...
  <div class="landing-scroll-container">
    <section class="snap-section section-hero active">
      ...
      <div class="landing-content fade-in-section">
        <!-- 新增：将系统登录按钮移至右上角 -->
        <button class="top-right-login-btn" @click="$emit('go-login')">登录</button>
...
.primary-btn { background: #3b82f6; color: #fff; border: none; padding: 10px 30px; border-radius: 20px; cursor: pointer; font-weight: bold; }
